...
The program will:
1. It will show a welcome message.
2. It will ask you to enter 1 or 2.
...
5. Once you enter 5 letters, it will immediately give you a feedback of correctness.
...
6. If you entered correct word, it will show win message.
7. If you entered wrong word, it will tell you how you were wrong.
	a) if you enter wrong words for 5 times, it will show lose message and tell you the correct answer.
	b) or else, it will tell you whether each letter is:
	' x ' not in the word
	'(x)' in the word

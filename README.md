...
2. Ask you to enter 1 or 2.
   - Once you enter a character, it will continue to run.
   - If you input a character other than 1 and 2, it will tell you to re-enter a number. Back to step 2.
3. If you enter 2, it will quit.
4. If you enter 1, it will immediately start the game and tell you to enter a word.
   - It will choose a random word for you to guess.
5. Once you enter 5 letters, it will immediately give you feedback on correctness.
   - Note that it is impossible for you to enter more than 5 characters.
   - If you press enter before you enter 5 characters, it will tell you to re-enter. Back to step 5.
...
7. If you entered the wrong word, it will tell you how you were wrong.
   - If you enter wrong words for 5 times, it will show a lose message and tell you the correct answer.
   - Otherwise, it will tell you whether each letter is:
      - ' x ': not in the word
      - '(x)': in the word
